...
class SortRunGenerationWorkOrder : public WorkOrder {
 public:
   ...
   * @brief Constructor.
   *
   * @param input_relation_schema The relation schema to generate sorted runs of.
   * @param sort_config The Sort configuration specifying ORDER BY, ordering and
   *        null ordering.
   * @param input_block_id The block id.
   * @param output_destination Where to store the sorted blocks of runs.
   * @param storage_manager The StorageManager to use.
   **/
  SortRunGenerationWorkOrder(const CatalogRelationSchema &input_relation_schema,
