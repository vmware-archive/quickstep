...
class SelectWorkOrder : public WorkOrder {
 public:
   ...
   * @brief Constructor.
   *
   * @param input_relation_schema The relation schema to perform selection over.
   ...
   * @param selection A list of Scalars which will be evaluated to project input
   *        tuples.
   * @param predicate All tuples matching \c predicate will be selected (or NULL
   *        to select all tuples).
   * @param output_destination Where to insert the selection results.
   * @param storage_manager The StorageManager to use.
   **/
  SelectWorkOrder(const CatalogRelationSchema &input_relation_schema,
