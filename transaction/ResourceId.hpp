...
public:
   ...
   *
   * @return True if this and other are the id of the same resource, false otherwise.
   **/
  ...
  /**
   * @brief This is a helper method for string representation of the resource id.
   * 
