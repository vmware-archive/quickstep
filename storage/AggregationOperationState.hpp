...
class AggregationOperationState {
 public:
   ...
   * @param is_distinct For each entry in aggregate_functions, whether the
   *        DISTINCT operator should be applied to the entry's arguments.
 ...
 private:
  ...
  // For each aggregate, whether the DISTINCT operator should be applied to the
