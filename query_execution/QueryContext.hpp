...
class QueryContext {
 public:
   ...
   **/
  inline bool isValidAggregationStateId(const aggregation_state_id id) const {
  ...
  /**
   * @brief Whether the InsertDestination id is valid.
   *
   * @param id The InsertDestination id.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidInsertDestinationId(const insert_destination_id id) const {
  ...
  /**
   * @brief Whether the JoinHashTable id is valid.
   *
   * @param id The JoinHashTable id.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidJoinHashTableId(const join_hash_table_id id) const {
  ...
  /**
   * @brief Whether the Predicate id is valid.
   *
   * @param id The Predicate id.
   *
   * @return True if valid or no predicate, otherwise false.
   **/
  inline bool isValidPredicateId(const predicate_id id) const {
   ...
   **/
  inline const Predicate* getPredicate(const predicate_id id) const {
  ...
  /**
   * @brief Whether the Scalar group id is valid.
   *
   * @param id The Scalar group id.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidScalarGroupId(const scalar_group_id id) const {
    if (id == kInvalidScalarGroupId) {
      return false;
    }

    return (id >= 0) && (static_cast<std::size_t>(id) < scalar_groups_.size());
  }
   ...
   *         constructor.
   **/
  inline const std::vector<std::unique_ptr<const Scalar>>& getScalarGroup(const scalar_group_id id) const {
    DCHECK_GE(id, 0);
  ...
  /**
   * @brief Whether the SortConfiguration id is valid.
   *
   * @param id The SortConfiguration id.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidSortConfigId(const sort_config_id id) const {
  ...
  /**
   * @brief Whether the Tuple id is valid.
   *
   * @param id The Tuple id.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidTupleId(const tuple_id id) const {
  ...
  /**
   * @brief Whether the update assignments group id is valid.
   *
   * @param id The group id of the update assignments.
   *
   * @return True if valid, otherwise false.
   **/
  inline bool isValidUpdateGroupId(const update_group_id id) const {
  ...
  inline const std::unordered_map<attribute_id, std::unique_ptr<const Scalar>>& getUpdateGroup(
      const update_group_id id) const {
