...
class AggregateFunction : public Expression {
 public:
  ...
  /*
   * @return Whether the DISTINCT operator should be applied to the arguments
   *         of this aggregation.
   */
   ...
   * @param is_distinct Whether the DISTINCT operator should be applied to the
   *        arguments of this aggregation.
 ...
 private:
   ...
   * @param is_distinct Indicates whether the DISTINCT operator should be applied
   *        to the arguments of this aggregation.
   */
